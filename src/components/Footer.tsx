        ...
        <div className="fixed bottom-6 right-6 flex flex-col items-center gap-3">
          ...
          >
            <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              <path d="M12.04 2a9.94 9.94 0 0 0 -8.52 15.1L2 22l5.05-1.48A9.95 9.95 0 1 0 12.04 2zm0 2a7.95 7.95 0 0 1 7.96 7.95 7.95 7.95 0 0 1 -7.96 7.95 7.9 7.9 0 0 1 -4.07-1.12l-.3-.18-2.98.87.9-2.9-.19-.31A7.9 7.9 0 0 1 4.09 12 7.95 7.95 0 0 1 12.04 4zm4.55 10.1c-.25-.13-1.47-.72-1.7-.8-.23-.09-.4-.13-.57.13-.17.25-.65.8-.8.96-.15.17-.3.19-.55.06-.25-.13-1.05-.39-2-1.25-.74-.66-1.24-1.48-1.39-1.73-.15-.25-.02-.38.11-.51.12-.12.25-.3.38-.45.13-.15.17-.25.25-.42.09-.17.04-.32-.02-.45-.06-.13-.57-1.36-.78-1.87-.2-.48-.41-.41-.57-.42h-.49c-.17 0-.45.06-.68.32-.23.25-.9.88-.9 2.15 0 1.27.92 2.5 1.05 2.68.13.17 1.82 2.78 4.41 3.9.62.27 1.1.43 1.48.55.62.2 1.18.17 1.62.1.5-.07 1.47-.6 1.68-1.18.21-.58.21-1.08.15-1.18-.06-.1-.23-.16-.48-.29z" />
            </svg>
          </a>
